...
We show that the annealed schedule is what keeps a learned rollout from executing a minimum of its own.
...
The wide stages select the basin and the last stage produces the executed command, and the separation disappears once the rollout is exact.
...
The wide schedules therefore come to rest at the edge of the band without settling inside it.No fixed level therefore meets both conditions at once.
